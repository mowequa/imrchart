imrchart<-function(x,xname,xLabName,bMed=F,bSD=F,bTests=rep(T,8),pTs=c(2,4,6,9,8,14,15)){
  ...
  #' @param  xname a character string for the name of the data vector, no default
